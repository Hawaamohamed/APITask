...
class AnnualEvaluationFeetDataTable extends DataTable
{
    /**
     ...
     *
     * @param AnnualEvaluationFeetDataTable $model
     * @return Builder
     */
    public function query(AnnualEvaluationFeet $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'skin_color' => new Column(['title' => 'Skin color', 'data' => 'skin_color']),
            'date' => new Column(['title' => 'Date', 'data' => 'date']),
            'time' => new Column(['title' => 'Time', 'data' => 'time']),
    ...
    {
        return 'annualEvaluationFeet_datatable_' . time();
    }
}
