...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'discount' => new Column(['title' => 'discount', 'data' => 'discount']),
            'month' => new Column(['title' => 'month', 'data' => 'month']),
            'year' => new Column(['title' => 'year', 'data' => 'year']),
    ...
    {
        return 'discount_datatable_' . time();
    }
}
