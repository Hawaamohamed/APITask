...
class PatientFollowUpDataTable extends DataTable
{
    /**
     ...
     *
     * @param PatientFollowUpDataTable $model
     * @return Builder
     */
    public function query(PatientFollowUp $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'type_of_disease' => new Column(['title' => 'type_of_disease', 'data' => 'type_of_disease']),
            'date_of_registration' => new Column(['title' => 'date_of_registration', 'data' => 'date_of_registration']),
            'diagnosis_date' => new Column(['title' => 'diagnosis_date', 'data' => 'diagnosis_date']),
    ...
    {
        return 'patientFollowUp_datatable_' . time();
    }
}
