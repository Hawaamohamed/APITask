...
class NewCaseDataTable extends DataTable
{
    /**
     ...
     *
     * @param NewCaseDataTable $model
     * @return Builder
     */
    public function query(NewCase $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'color' => new Column(['title' => 'color', 'data' => 'color']), 
    ...
    {
        return 'newCase_datatable_' . time();
    }
}
