...
class EarlyComplicationDataTable extends DataTable
{
    /**
     ...
     *
     * @param EarlyComplicationDataTable $model
     * @return Builder
     */
    public function query(EarlyComplication $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'cardiovascular_complications' => new Column(['title' => 'cardiovascular_complications', 'data' => 'cardiovascular_complications']),
            'apoplexy' => new Column(['title' => 'apoplexy', 'data' => 'apoplexy']),
            'complications_in_urinary_system' => new Column(['title' => 'complications_in_urinary_system', 'data' => 'complications_in_urinary_system']),
    ...
    {
        return 'earlyComplication_datatable_' . time();
    }
}
