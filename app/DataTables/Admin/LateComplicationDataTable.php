...
class LateComplicationDataTable extends DataTable
{
    /**
     ...
     *
     * @param LateComplicationDataTable $model
     * @return Builder
     */
    public function query(LateComplication $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'heart_attack' => new Column(['title' => 'heart_attack', 'data' => 'heart_attack']),
            'congestive_heart_failure' => new Column(['title' => 'congestive_heart_failure', 'data' => 'congestive_heart_failure']),
            'apoplexy' => new Column(['title' => 'Time', 'apoplexy' => 'apoplexy']),
    ...
    {
        return 'lateComplication_datatable_' . time();
    }
}
