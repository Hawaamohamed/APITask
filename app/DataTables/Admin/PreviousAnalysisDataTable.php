...
class PreviousAnalysisDataTable extends DataTable
{
    /**
     ...
     *
     * @param PreviousAnalysisDataTable $model
     * @return Builder
     */
    public function query(PreviousAnalysis $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'fasting_sugar' => new Column(['title' => 'fasting_sugar', 'data' => 'fasting_sugar']),
            'date' => new Column(['title' => 'Date', 'data' => 'date']),
            'glucose_meter' => new Column(['title' => 'glucose_meter', 'data' => 'glucose_meter']),
    ...
    {
        return 'previousAnalysis_datatable_' . time();
    }
}
