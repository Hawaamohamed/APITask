...
class AttachmentDataTable extends DataTable
{
     ...
     *
     * @param AttachmentDataTable $model
     * @return Builder
     */
    public function query(Attachment $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'file_name' => new Column(['title' => 'file_name', 'data' => 'file_name']),
        ];
    }
    ...
    {
        return 'attachment_datatable_' . time();
    }
}
