...
class ProcedureForPatientDataTable extends DataTable
{
    /**
     ...
     *
     * @param ProcedureForPatientDataTable $model
     * @return Builder
     */
    public function query(ProcedureForPatient $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'procedures' => new Column(['title' => 'procedures', 'data' => 'procedures']),  
        ];
    }
    ...
    {
        return 'procedureForPatient_datatable_' . time();
    }
}
