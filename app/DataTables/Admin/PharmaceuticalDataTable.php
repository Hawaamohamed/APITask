...
class PharmaceuticalDataTable extends DataTable
{
    /**
     ...
     *
     * @param PharmaceuticalDataTable $model
     * @return Builder
     */
    public function query(Pharmaceutical $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'medicament_name' => new Column(['title' => 'medicament_name', 'data' => 'medicament_name']),
            'amount_spent' => new Column(['title' => 'amount_spent', 'data' => 'amount_spent']),
            'pharmaceutical_form' => new Column(['title' => 'pharmaceutical_form', 'data' => 'pharmaceutical_form']),
    ...
    {
        return 'pharmaceutical_datatable_' . time();
    }
}
