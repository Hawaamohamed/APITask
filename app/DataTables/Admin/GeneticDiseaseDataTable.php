...
class GeneticDiseaseDataTable extends DataTable
{
    /**
     ...
     *
     * @param GeneticDiseaseDataTable $model
     * @return Builder
     */
    public function query(GeneticDisease $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'hypertension' => new Column(['title' => 'hypertension', 'data' => 'hypertension']),
            'diabetes' => new Column(['title' => 'diabetes', 'data' => 'diabetes']),
    ...
    {
        return 'geneticDisease_datatable_' . time();
    }
}
