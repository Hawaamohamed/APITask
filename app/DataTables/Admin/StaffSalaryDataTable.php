...
class StaffSalaryDataTable extends DataTable
{
     ...
     *
     * @param StaffSalaryDataTable $model
     * @return Builder
     */
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'salary_no' => new Column(['title' => 'salary_no', 'data' => 'salary_no']),
            'salary_address' => new Column(['title' => 'salary_address', 'data' => 'salary_address']),
            'salary' => new Column(['title' => 'salary', 'data' => 'salary']),
    ...
    {
        return 'staffSalary_datatable_' . time();
    }
}
