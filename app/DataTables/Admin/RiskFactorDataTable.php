...
class RiskFactorDataTable extends DataTable
{
    /**
     ...
     *
     * @param RiskFactorDataTable $model
     * @return Builder
     */
    public function query(RiskFactor $model)
    {
...
//                'initComplete' => 'function() { $(\'ul.pagination\').addClass(\'flex-wrap\'); }',
    ...
    protected function getColumns()
    {
        return [
            ...
            'obesity' => new Column(['title' => 'obesity', 'data' => 'obesity']),
            'smoking' => new Column(['title' => 'smoking', 'data' => 'smoking']),
            'level_cholesterol_in_blood' => new Column(['title' => 'level_cholesterol_in_blood', 'data' => 'level_cholesterol_in_blood']),
    ...
    {
        return 'riskFactor_datatable_' . time();
    }
}
